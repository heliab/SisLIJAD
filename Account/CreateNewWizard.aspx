<%@ Page Title="" Language="C#" MasterPageFile="~/Account/AccountMASTER.Master" AutoEventWireup="true" CodeBehind="CreateNewWizard.aspx.cs" Inherits="SisLIJAD.Account.CreateNewWizard" %>
                        ...
                        <table style="font-size: 10pt; font-family: Verdana" border="0" width="400">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  ControlToValidate="Nombres"
                                        ErrorMessage="Escriba un nombre" ValidationGroup="CreateUserWizard1">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
