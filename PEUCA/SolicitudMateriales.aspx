<%@ Page Title="Solicitud de Materiales" Language="C#" MasterPageFile="~/PEUCA/MasterPREUCA.Master"
    AutoEventWireup="true" CodeBehind="SolicitudMateriales.aspx.cs" Inherits="SisLIJAD.PEUCA.SolicitudMateriales" %>
                                    ...
                                    <dx:ContentControl runat="server" SupportsDisabledAttribute="True">
                                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" ClientIDMode="AutoID" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Nombre Solicitante" FieldName="NombCompleto"
