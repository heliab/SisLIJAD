...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function fn_DeleteSolJS() {
            GridPrincipal.GetRowValues(GridPrincipal.GetFocusedRowIndex(), 'Aprobado', SetEnv);
            function SetEnv(Value) {
                if (Value == 1) {
                    alert('El registro ya ha sido aprobado y no puede realizar cambios');
                    return
    ...
    <div class="wrapctrl">
        <ul class="ctrlist">
            <li><a class="pure-button blue-font" href="javascript:fn_NewJS();" title="Nuevo">
                 ...
                 <li><a class="pure-button red-font" href="javascript:fn_SendJS();" title="Enviar solicitud">
                ...
                <dx:ASPxGridView ID="SubGrid" runat="server" AutoGenerateColumns="False" ClientIDMode="AutoID"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="CodDetalle" ReadOnly="True" 
                            ShowInCustomizationForm="True" VisibleIndex="0" Width="13%">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Material" FieldName="NomMaterial" 
                            ShowInCustomizationForm="True" VisibleIndex="1">
                            <Settings AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="Codigo UCA" FieldName="CodUCA" 
                            ShowInCustomizationForm="True" VisibleIndex="2" Width="12%">
                            <Settings AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                            ...
                            <div class="form">
                                ...
                                <div>
                                    ...
                                    <asp:SqlDataSource ID="SDSMateriales" runat="server" 
                                        ...
                                        SelectCommand="SELECT IdMaterial, NomMaterial FROM MINV_Materiales WHERE (IdMaterial NOT IN (SELECT MINV_Materiales.IdMaterial FROM MINV_Det_Prestamo WHERE (IdDetPrest = @IdDetPrest))) AND (Prestamo = 1)">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="IdDetPrest" SessionField="IdDetPrest" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </div>
                                <div>
                                    <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text="Observación adicional">
                                    </dx:ASPxLabel>
