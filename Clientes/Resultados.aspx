<%@ Page Title="Resultados" Language="C#" MasterPageFile="~/Clientes/ClientesMASTER.Master"
    AutoEventWireup="true" CodeBehind="Resultados.aspx.cs" Inherits="SisLIJAD.Clientes.Resultados" %>
    ...
    <script type="text/javascript">
        ...
        function fn_IrCalculo(e) {
            ...
            function fn_GetValues(val) {
                switch (val[1]) {
                    case 1: window.location.href = "/Clientes/Results/PesoVolumetricoSecoSueltoRes.aspx?Id=" + val[0] + "&Sol=" + fn_GetIdPrValue() + "&Pr=" + val[1];
                        break;
                    ...
                    case 7: window.location.href = "/Clientes/Results/PorcentAbsFinoRes.aspx?Id=" + val[0] + "&Sol=" + fn_GetIdPrValue() + "&Pr=" + val[1];
                        break;
                    case 8: window.location.href = "/Clientes/Results/PorcentAbsGrueso.aspx?Id=" + val[0] + "&Sol=" + fn_GetIdPrValue() + "&Pr=" + val[1];
                        break;
...
<asp:Content ID="Content3" ContentPlaceHolderID="GridContent" runat="server">
	...
	GridPrincipal.SetFocusedRowIndex(e.visibleIndex);
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="HeaderSolicPrueba" VisibleIndex="1" Caption="Descripcion Solicitud">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="FechaRegistro" VisibleIndex="2" Width="20%">
                </dx:GridViewDataTextColumn>
                ...
                <DetailRow>
                    ...
                    <dx:ASPxGridView ID="SubGrid" runat="server" AutoGenerateColumns="False" ClientIDMode="AutoID"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="IdPrueba" VisibleIndex="3" Width="10%">
                            </dx:GridViewDataTextColumn>
