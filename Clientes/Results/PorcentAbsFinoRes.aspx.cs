...
{
    public partial class PorcentAbsFinoRes : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            ...
            ReportDataSource rds = new ReportDataSource("GetASTM128_ABS_ById", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = "Clientes/DSRPT/PorcentAbsFino.rdlc";
        ...
        private DataTable GetData(string IdSol, string IdPr)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetASTM128_ABS_ById", con);
