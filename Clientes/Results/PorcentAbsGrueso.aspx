<%@ Page Title="" Language="C#" MasterPageFile="~/Clientes/ClientesMASTER.Master"
    AutoEventWireup="true" CodeBehind="PorcentAbsGrueso.aspx.cs" Inherits="SisLIJAD.Clientes.Results.PorcentAbsGrueso" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="GridContent" runat="server">
    ...
    <dx:ASPxGridView ID="GridResultados" runat="server" ClientInstanceName="GridResultados"
        ...
        <Columns>
            <dx:GridViewDataTextColumn FieldName="Codigo" ReadOnly="True" VisibleIndex="0" ShowInCustomizationForm="True"
                Width="15%">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="FechaEmisionIndiv" VisibleIndex="1" Width="16%"
            ...
            <dx:GridViewDataTextColumn FieldName="Resultados" VisibleIndex="4" ShowInCustomizationForm="True">
