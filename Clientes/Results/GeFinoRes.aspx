<%@ Page Title="" Language="C#" MasterPageFile="~/Clientes/ClientesMASTER.Master" AutoEventWireup="true" CodeBehind="GeFinoRes.aspx.cs" Inherits="SisLIJAD.Clientes.Results.GeFinoRes" %>
        ...
        <dx:ASPxGridView ID="GridResultados" runat="server" ClientInstanceName="GridResultados"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="C128_S_Ge" VisibleIndex="5" 
                    Caption="Masa de muestra saturada seca" Width="5%">
                    <PropertiesTextEdit DisplayFormatString="{0} g">
                    </PropertiesTextEdit>
                </dx:GridViewDataTextColumn>
