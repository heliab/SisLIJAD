<%@ Page Title="" Language="C#" MasterPageFile="~/Clientes/ClientesMASTER.Master"
    AutoEventWireup="true" CodeBehind="PorcentAbsFinoRes.aspx.cs" Inherits="SisLIJAD.Clientes.Results.PorcentAbsFinoRes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="GridContent" runat="server">
    ...
    <dx:ASPxGridView ID="GridResultados" runat="server" ClientInstanceName="GridResultados"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="FechaEmisionIndiv" VisibleIndex="1" Width="15%">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="C128_A_Abs" VisibleIndex="2" Caption="Peso de la muestra seca"
                Width="20%">
                <PropertiesTextEdit DisplayFormatString="{0} g">
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="C128_S_Abs" VisibleIndex="3" Caption="Peso muestra saturada superf. seca"
                Width="20%">
                <PropertiesTextEdit DisplayFormatString="{0} g">
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Resultado" VisibleIndex="4">
