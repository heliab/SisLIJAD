<%@ Page Title="" Language="C#" MasterPageFile="~/Clientes/ClientesMASTER.Master"
    AutoEventWireup="true" CodeBehind="GeaFinoRes.aspx.cs" Inherits="SisLIJAD.Clientes.Results.GeaFinoRes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FormContent" runat="server">
    <div class="BaseForm wraptitle">
        <div class="row">
            <div class="first">
                <div class="Titulo2">
                    Gravedad Especifica Aparente Agregado Fino
                </div>
            </div>
            <div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="GridContent" runat="server">
    ...
    <dx:ASPxGridView ID="GridResultados" runat="server" ClientInstanceName="GridResultados"
        ...
        <Columns>
            <dx:GridViewDataTextColumn FieldName="Codigo" ReadOnly="True" VisibleIndex="0" Width="12%"
                ShowInCustomizationForm="True">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="FechaEmisionIndiv" VisibleIndex="1" Width="12%"
                ShowInCustomizationForm="True">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="C128_A_Gea" VisibleIndex="2" Caption="Masa Seca"
                Width="10%" ShowInCustomizationForm="True">
                <PropertiesTextEdit DisplayFormatString="{0} g">
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="C128_B_Gea" VisibleIndex="3" Caption="Masa picnometro con agua"
                Width="10%" ShowInCustomizationForm="True">
                <PropertiesTextEdit DisplayFormatString="{0} g">
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="C128_C_Gea" VisibleIndex="4" Caption="Masa picnometro muestra mas agua"
                Width="10%" ShowInCustomizationForm="True">
                <PropertiesTextEdit DisplayFormatString="{0} g">
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Resultado" VisibleIndex="5" ShowInCustomizationForm="True">
