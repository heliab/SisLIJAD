...
{
    public partial class GEssFinoRes : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            ...
            ReportDataSource rds = new ReportDataSource("GetASTM128_SSD_ById", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = "Clientes/DSRPT/Rpt_GEssFino.rdlc";
        ...
        private DataTable GetData(string IdSol, string IdPr)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetASTM128_SSD_ById", con);
