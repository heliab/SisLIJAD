...
namespace SisLIJAD.Clientes.Results
{
    public partial class PorcentAbsGrueso : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            ...
            ReportDataSource rds = new ReportDataSource("GetASTM127_ABS_ById", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = "Clientes/DSRPT/Rpt_PorcentAbsGrueso.rdlc";
        ...
        private DataTable GetData(string IdSol, string IdPr)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetASTM127_ABS_ById", con);
