...
namespace SisLIJAD.Clientes.Results
{
    public partial class GEGruesoRes : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            ...
            ReportDataSource rds = new ReportDataSource("DSGetASTM127_OD_ById", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = "Clientes/DSRPT/Rpt_GEGrueso.rdlc";
        ...
        private DataTable GetData(string IdSol, string IdPr)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetASTM127_OD_ById", con);
