...
namespace SisLIJAD.Clientes.Results
{
    public partial class GeFinoRes : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            ...
            ReportDataSource rds = new ReportDataSource("DSGetASTM128_OD_ById", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = "Clientes/DSRPT/Rpt_GeFinoRes.rdlc";
        ...
        private DataTable GetData(string IdSol, string IdPr)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("GetASTM128_OD_ById", con);
