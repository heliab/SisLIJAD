<%@ Page Title="" Language="C#" MasterPageFile="~/Tecnicos/TecnicosMASTER.Master" AutoEventWireup="true" CodeBehind="EntregaMaterialesPrestamo.aspx.cs" Inherits="SisLIJAD.Tecnicos.EntregaMaterialesPrestamo" %>
            ...
            <DetailRow>
                ...
                <dx:ASPxGridView ID="SubGrid" runat="server" AutoGenerateColumns="False" ClientIDMode="AutoID"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="NomMaterial" 
                            ShowInCustomizationForm="True" VisibleIndex="1" Caption="Material">
                            <Settings AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="CodUCA" 
                            ShowInCustomizationForm="True" VisibleIndex="2" Caption="Codigo UCA" 
                            Width="12%">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataCheckColumn FieldName="Prestado" ShowInCustomizationForm="True" 
                            VisibleIndex="5" Width="9%">
                        </dx:GridViewDataCheckColumn>
                        <dx:GridViewCommandColumn ShowInCustomizationForm="True" VisibleIndex="6" 
                            Width="0%">
                            <ClearFilterButton Text="Limpiar" Visible="True">
                            </ClearFilterButton>
                        </dx:GridViewCommandColumn>
                            ...
                            <ContentCollection>
                                <dx:ContentControl ID="ContentControl2" runat="server" SupportsDisabledAttribute="True">
                                    <dx:ASPxGridView ID="ASPxGridView1" runat="server" ClientIDMode="AutoID" 
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn 
                                                FieldName="Cedula" ShowInCustomizationForm="True" VisibleIndex="0" 
                                                Width="24%">
                                            </dx:GridViewDataTextColumn>
