<%@ Page Title="" Language="C#" MasterPageFile="~/MINV/MasterMinv.Master" AutoEventWireup="true" CodeBehind="UbicacionesEspecificas.aspx.cs" Inherits="SisLIJAD.MINV.UbicacionesEspecificas" %>
...
txtId.SetText(GridId);
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="NomBodega" 
                VisibleIndex="1" Caption="Nombre" Width="35%">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="DescBodega" VisibleIndex="2" 
                Caption="Descrpcion">
            </dx:GridViewDataTextColumn>
        </Columns>
    ...
    <asp:SqlDataSource ID="SDSTBodegas" runat="server" ConnectionString="<%$ ConnectionStrings:BDLabsConnectionString %>"
        
        
        
        SelectCommand="SELECT [IdBodega], [NomBodega], [DescBodega] FROM [MINV_Bodegas]">
    </asp:SqlDataSource>
                ...
                <dx:ASPxCallbackPanel ID="FillingCallback" runat="server" ClientInstanceName="FillingCallback"
                    ...
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            ...
                            <div>
                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Nombre bodega">
                                </dx:ASPxLabel>
                                <dx:ASPxTextBox ID="txtBod" runat="server" Width="170px" ClientInstanceName="txtBod"
                                ...
                                <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Descripción de bodega">
                                 </dx:ASPxLabel>
                                <dx:ASPxMemo ID="mDesc" runat="server" Height="71px" Width="80%"
                                    ClientInstanceName="mDesc" 
                                    NullText="Puede añadir una descripción a la bodega.">
                                    <ValidationSettings ValidationGroup="ControlGroup1">
                                    </ValidationSettings>
                                </dx:ASPxMemo>
                                                           </div>
