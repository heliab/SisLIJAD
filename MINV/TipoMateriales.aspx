<%@ Page Title="" Language="C#" MasterPageFile="~/MINV/MasterMinv.Master" AutoEventWireup="true" CodeBehind="TipoMateriales.aspx.cs" Inherits="SisLIJAD.MINV.TipoMateriales" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="GridContent" runat="server">
    <dx:ASPxGridView ID="GridPrincipal" runat="server" AutoGenerateColumns="False" ClientIDMode="AutoID"
        DataSourceID="SDSTipoMaterial" KeyFieldName="IdTipoMat" SettingsBehavior-AllowFocusedRow="True"
...
txtId.SetText(GridId);
        ...
        <Columns>
            <dx:GridViewDataTextColumn Caption="Id" FieldName="IdTipoMat" ReadOnly="True" 
                VisibleIndex="0" Width="4%">
                <EditFormSettings Visible="False" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Tipo Material" FieldName="DescTipoMat" 
                VisibleIndex="1">
            </dx:GridViewDataTextColumn>
        </Columns>
    ...
    <asp:SqlDataSource ID="SDSTipoMaterial" runat="server" ConnectionString="<%$ ConnectionStrings:BDLabsConnectionString %>"
        
        SelectCommand="SELECT [IdTipoMat], [DescTipoMat] FROM [MINV_Tipo_Material]">
    </asp:SqlDataSource>
