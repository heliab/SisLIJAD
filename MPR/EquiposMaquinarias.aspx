    ...
    <dx:ASPxMenu ID="ASPxMenu1" runat="server" AutoSeparators="RootOnly" BorderBetweenItemAndSubMenu="HideRootOnly"
        ...
        <Items>
            ...
            <dx:MenuItem BeginGroup="True" Text="Solicitudes">
                <Items>
                    <dx:MenuItem Text="Solicitud Pendientes" NavigateUrl="~/MPR/SolicitudesPruebas.aspx">
                    </dx:MenuItem>
            ...
            <dx:MenuItem Text="Mantenimiento">
                <Items>
                    ...
                    <dx:MenuItem NavigateUrl="~/MPR/EquiposMaquinarias.aspx" Text="Equipos y maquinarias">
                    </dx:MenuItem>
                        ...
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <div class="form">
                                ...
                                <div>
                                    ...
                                    <dx:ASPxComboBox ID="cmbUbicEspec" runat="server" ClientInstanceName="cmbUbicEspec"
                                        DataSourceID="SDSTipoUbicEspec" TextField="Ubi" ValueField="Id" OnCallback="UbicEspec_Callback">
                                        <Columns>
                                ...
                                <asp:SqlDataSource ID="SDSTipoUbicEspec" runat="server" ConnectionString="<%$ ConnectionStrings:BDLabsConnectionString %>"
                                    ...
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="cmbUbic" Name="IdUbicacion" PropertyName="Value" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </div>
                            <div>
