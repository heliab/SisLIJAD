...
--%>
    ...
    <ul class="ctrlist">
        <li><a class="pure-button" href="javascript:fn_NewJS();" title="Nuevo"><i class="fa fa-plus"></i> Nuevo</a></li>
        <li><a class="pure-button" href="javascript:fn_EditJS();" title="Editar"><i class="fa fa-pencil-square-o"></i> Editar</a></li>
        <li><a class="pure-button pure-button-primary" href="javascript:fn_DeleteJS();" title="Borrar"><i class="fa fa-trash"></i> Borrar</a></li>
    </ul>
 
     </div>
    <dx:ASPxCallback ID="NewCallback" runat="server" 
        ClientInstanceName="NewCallback" oncallback="NewCallback_Callback" 
        ClientIDMode="AutoID">
...
fn_EndCallback();
    ...
    <dx:ASPxCallback ID="DelCallback" runat="server" 
        ClientInstanceName="DelCallback" oncallback="DelCallback_Callback">
    <ClientSideEvents EndCallback="function(s, e) {
...
<asp:Content ID="Content4" ContentPlaceHolderID="PopupContent" runat="server">
    <dx:ASPxPopupControl ID="FormPopup" runat="server" ClientInstanceName="FormPopup"
        ...
        Height="186px" Width="298px" CloseAction="CloseButton">
...
fn_EndCallback();
                    ...
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            ...
                            <div>
                                <ul class="frmctrl">
                                    <li><a class="pure-button" href="javascript:fn_SaveJS()" title="Guardar"><i class="fa fa-floppy-o"></i>Guadar</a></li>
                                    <li><a class="pure-button" href="javascript:fn_CancelJS()" title="Cancelar"><i class="fa fa-times"></i>Cancelar</a></li>
                                    <li><a class="pure-button" href="javascript:fn_CleanGroup(1);" title="Limpiar"><i class="fa fa-repeat"></i>Limpiar</a></li>
                                </ul>
                            </div>
                        </dx:PanelContent>
                    </PanelCollection>
            ...
            <dx:PopupControlContentControl ID="PopupControlContentControl4" runat="server">
                    ...
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent4" runat="server">
                            ...
                            <div>
                                <ul>
                                    <li><a href="javascript:fn_ConfirmDJS()" title="Borrar">Borrar</a></li>
                                    <li><a href="javascript:fn_CancelDJS()" title="Cancelar">Cancelar</a></li></ul>
                                <dx:ASPxButton ID="btnConfirmD" runat="server" Text="Confirmar" AutoPostBack="False"
