...
fn_New();
 ASPxClientEdit.ClearGroup('ControlGroup1');
    ...
    <dx:ASPxButton ID="btnSelect" runat="server" Text="Editar" AutoPostBack="True" OnClick="btnSelect_Click">
        <ClientSideEvents Click="function(s, e) {
 FormPopup.Show();
}" />
    </dx:ASPxButton>
    ...
    <ul>
        <li><a href="javascript:fn_ShowMessage();" title="Borrar">MOstrar Mensaje</a></li>
        <li><a href="javascript:fn_NewJS();" title="Nuevo">Nuevo</a></li>
        <li><a href="javascript:fn_EditJS();" title="Editar">Editar</a></li>
        <li><a href="javascript:fn_ShowMessage();" title="Borrar">Borrar</a></li>
    </ul>
...
GridPrincipal.PerformCallback();
                    ...
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            ...
                            <div>
                                <dx:ASPxButton ID="btnGuardar" runat="server" Text="Guardar" AutoPostBack="False"
                                ...
                                <ul>
                                    <li><a href="javascript:fn_SaveJS()" title="Guardar">Guadar</a></li>
                                    <li><a href="javascript:fn_CancelJS()" title="Cancelar">Cancelar</a></li>
                                    <li><a href="javascript:fn_CleanGroup(1);" title="Limpiar">Limpiar</a></li>
                                </ul> 
                            </div>
                        </dx:PanelContent>
                    </PanelCollection>
