...
{
    public partial class TiposPrueba : System.Web.UI.Page
    {
        ...
        protected void Select()
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    txtNom.Text = dr["NomTipo"].ToString();
                }
                else
                {
        ...
        protected void Insert()
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@NomTipo", txtNom.Text);

                int count = cmd.ExecuteNonQuery();
                if (count == 1)
                {
                    Response.Write("<script>alert('" + Server.HtmlEncode("El tipo " + txtNom.Text + " se ha guardado correctamente") + "')</script>");
