    ...
    <div class="wrapctrl">
        <ul class="ctrlist">
            ...
            <li id="leftmar-button"><a class="pure-button green-font" href="javascript:GetAprobRow()"
                title="Aprobar"><i class="fa fa-check-square-o"></i>Autorizar</a></li>
<li><a class="pure-button green-font" href="javascript:GetAprobRow()"
                title="Aprobar"><i class="fa fa-money"></i>Pagado?</a></li>
        </ul>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="GridContent" runat="server">
    <dx:ASPxGridView ID="GridPrincipal" runat="server" AutoGenerateColumns="False" ClientIDMode="AutoID"
        DataSourceID="SDSSolic" KeyFieldName="IdSolicPrueba" SettingsBehavior-AllowFocusedRow="True"
        Width="100%" ClientInstanceName="GridPrincipal" 
        OnCustomCallback="GridPrincipal_CustomCallback">
        <Columns>
            <dx:GridViewDataTextColumn FieldName="IdSolicPrueba" 
                ReadOnly="True" VisibleIndex="0" Caption="Id Solicitud" Width="7%">
                <EditFormSettings Visible="False" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="HeaderSolicPrueba" 
                VisibleIndex="1" Caption="Descripcion solicitiud" Width="23%">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataDateColumn FieldName="FechaRegistro" VisibleIndex="2" 
                Width="10%">
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataDateColumn FieldName="FechaAprobación" VisibleIndex="3" 
                Width="10%">
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataTextColumn FieldName="Pagado" VisibleIndex="4" Width="10%">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Autorizado" VisibleIndex="5" Width="10%">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="username" VisibleIndex="6" Width="15%" 
                Caption="Usuario">
            </dx:GridViewDataTextColumn>
        </Columns>
    ...
    <asp:SqlDataSource ID="SDSSolic" runat="server" ConnectionString="<%$ ConnectionStrings:BDLabsConnectionString %>"
        
        
        
        SelectCommand="SELECT IdSolicPrueba, HeaderSolicPrueba, FechaRegistro, FechaAprobación, Pagado, Autorizado, username FROM MPR_Solic_Pruebas ORDER BY IdSolicPrueba DESC">
    </asp:SqlDataSource>
</asp:Content>
