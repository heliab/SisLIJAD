...
namespace SisLIJAD.MPR
{
    public partial class EquiposMaquinarias : System.Web.UI.Page
    {
        ...
        protected void Select()
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    txtUnd.Text = dr["NomMaq"].ToString();
                    txtAbvr.Text = dr["NumSerie"].ToString();
                }
                else
                {
        ...
        protected void Insert()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("insert into MPR_EquipMaquin (NomMaq,NumSerie) values(@NomMaq,@NumSerie)", con);
                cmd.Parameters.AddWithValue("@NomMaq", txtUnd.Text);
                cmd.Parameters.AddWithValue("@NumSerie", txtAbvr.Text);
        ...
        protected void Update()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update MPR_EquipMaquin set NomMaq=@NomMaq,NumSerie=@NumSerie where IdEquipo = @IdEquipo", con);
                cmd.Parameters.AddWithValue("@IdEquipo", txtId.Text);
                cmd.Parameters.AddWithValue("@NomMaq", txtUnd.Text);
                cmd.Parameters.AddWithValue("@NumSerie", txtAbvr.Text);
                cmd.Parameters.AddWithValue("@IdUbicacion", txtAbvr.Text);
