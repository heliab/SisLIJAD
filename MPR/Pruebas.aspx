<%@ Page Title="" Language="C#" MasterPageFile="~/MINV/MasterMinv.Master" AutoEventWireup="true" CodeBehind="Pruebas.aspx.cs" Inherits="SisLIJAD.MPR.Pruebas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="GridContent" runat="server">
    <dx:ASPxGridView ID="GridPrincipal" runat="server" AutoGenerateColumns="False" ClientIDMode="AutoID"
        DataSourceID="SDSTipoP" KeyFieldName="IdPrueba" SettingsBehavior-AllowFocusedRow="True"
        Width="100%" ClientInstanceName="GridPrincipal" 
        OnCustomCallback="GridPrincipal_CustomCallback">
        <Columns>
            <dx:GridViewDataTextColumn FieldName="IdPrueba" 
                ReadOnly="True" VisibleIndex="0"
                Width="7%">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Nombre Prueba" FieldName="NomPrueba" 
                VisibleIndex="1" Width="15%">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Descripcion prueba" FieldName="DescPrueba" 
                VisibleIndex="2" Width="20%">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Duracion días" FieldName="Duracion" 
                VisibleIndex="3" Width="10%">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Laboratorio" FieldName="DescUbicacion" 
                VisibleIndex="4">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource ID="SDSTipoP" runat="server" ConnectionString="<%$ ConnectionStrings:BDLabsConnectionString %>"
        ...
        SelectCommand="SELECT MPR_Prueba.IdPrueba, MPR_Prueba.NomPrueba, MPR_Prueba.DescPrueba, MPR_Prueba.Duracion, MINV_Ubicaciones.DescUbicacion, MPR_Prueba.Precio, MPR_Tipo_Prueba.NomTipo FROM MPR_Prueba INNER JOIN MPR_Tipo_Prueba ON MPR_Prueba.IdTipoPrueba = MPR_Tipo_Prueba.IdTipoPrueba INNER JOIN MINV_Ubicaciones ON MPR_Prueba.IdUbicacion = MINV_Ubicaciones.IdUbicacion">
    </asp:SqlDataSource>
</asp:Content>
                        ...
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            <div class="form">
                                ...
                                <div>
                                    ...
                                    <dx:ASPxMemo ID="memoDesc" runat="server" ClientInstanceName="memoDesc" 
                                        Height="71px" Width="275px"
                                    ValidationSettings-ValidationGroup="ControlGroup1" 
                                        NullText="Puede añadir contenido adicional a la prueba aquí">
<ValidationSettings ValidationGroup="ControlGroup1"></ValidationSettings>
                                ...
                                <div>
                                    ...
                                    <dx:ASPxComboBox ID="cmbUbic" runat="server" ClientInstanceName="cmbUbic" 
                                        DataSourceID="SDSLabs">
                                    <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom"
                                            SetFocusOnError="True" ValidationGroup="ControlGroup1">
                                            <RegularExpression ErrorText="Informacion Requerida" />
                                            <RequiredField ErrorText="Informacion Requerida" IsRequired="True" />
                                    ...
                                    <asp:SqlDataSource ID="SDSLabs" runat="server"></asp:SqlDataSource>
                                </div>
                                 <div>
                               ...
                               <div>
                                   ...
                                   <asp:SqlDataSource ID="SDSTipoPr" runat="server"></asp:SqlDataSource>
                                </div>
                             <div>
                                <ul class="frmctrl">
