...
txtId.SetText(GridId);
        ...
        <Columns>
            <dx:GridViewDataTextColumn Caption="Id" FieldName="IdServicio" ReadOnly="True" 
                VisibleIndex="0" Width="4%">
                <EditFormSettings Visible="False" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Tipo Servicio" FieldName="NomServicio" 
                VisibleIndex="1">
            </dx:GridViewDataTextColumn>
        </Columns>
                    ...
                    <PanelCollection>
                        <dx:PanelContent ID="PanelContent1" runat="server">
                            ...
                            <div>
                                ...
                                <dx:ASPxTextBox ID="txtServ" runat="server" Width="170px" ClientInstanceName="txtServ"
