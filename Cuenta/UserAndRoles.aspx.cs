    ...
    public partial class UserAndRoles : System.Web.UI.Page
    {
        ...
        protected void RoleCheckBox_CheckChanged(object sender, EventArgs e)
        {
            ...
            if (RoleCheckBox.Checked)
            {
                ...
                ActionStatus.Text = string.Format("El usuario {0} fue añadido al rol {1}.", selectedUserName, roleName);
            }
            else
            {
                ...
                // Display a status message
                ActionStatus.Text = string.Format("El usuaio {0} fue eliminado del rol {1}.", selectedUserName, roleName);
            }
        ...
        protected void RolesUserList_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            // Display a status message
            ActionStatus.Text = string.Format("El usuaio {0} fue eliminado del rol {1}.", UserNameLabel.Text, selectedRoleName);
        ...
        protected void AddUserToRoleButton_Click(object sender, EventArgs e)
        {
            ...
            {
                ActionStatus.Text = "Debe ingresar un usuario en la caja de texto.";
                return;
            }
            ...
            {
                ActionStatus.Text = string.Format("El usuario {0} ya es miembro del rol {1}.", userNameToAddToRole, selectedRoleName);
                return;
            }
            ...
            // Display a status message
            ActionStatus.Text = string.Format("El usuario {0} fue añadido al rol {1}.", userNameToAddToRole, selectedRoleName);
