...
<asp:Content ID="Content3" ContentPlaceHolderID="GridContent" runat="server">
    ...
    <asp:SqlDataSource ID="SDSEnsayes" runat="server" ConnectionString="<%$ ConnectionStrings:BDLabsConnectionString %>"
        ...
        SelectCommand="SELECT CAST(MPR_Solic_Pruebas.IdSolicPrueba AS NVARCHAR) + '.' + CAST(MPR_Prueba.IdPrueba AS NVARCHAR) + '.' + CAST(MPR_Det_Result_Prueba.IdCalc AS NVARCHAR) AS Codigo, MPR_Det_Result_Prueba.FechaEmisionIndiv, MPR_Det_Result_Prueba.C29_G, MPR_Det_Result_Prueba.C29_T, MPR_Det_Result_Prueba.C29_V,MPR_Det_Result_Prueba.C29_F, MPR_Det_Result_Prueba.C29_M_Result FROM MPR_Solic_Pruebas INNER JOIN MPR_Det_Result_Prueba ON MPR_Solic_Pruebas.IdSolicPrueba = MPR_Det_Result_Prueba.IdSolicPrueba INNER JOIN MPR_Prueba ON MPR_Det_Result_Prueba.IdPrueba = MPR_Prueba.IdPrueba WHERE (MPR_Solic_Pruebas.Autorizado = 1) AND (MPR_Solic_Pruebas.IdSolicPrueba = @Sol) AND (MPR_Prueba.IdPrueba = @Pr)">
        <SelectParameters>
        ...
        <ContentCollection>
            <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server">
                <dx:ASPxCallbackPanel ID="FillingCallback2" runat="server" ClientInstanceName="FillingCallback2"
                    Width="100%" OnCallback="FillingCallback2_Callback" 
                    CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" 
                    ...
                    <br />
                     ...
                     <div class="second">
                         ...
                         <dx:ASPxTextBox ID="ASPxTextBox2" runat="server" Width="125px" ClientInstanceName="txtResult"
                             ReadOnly="True">
                             <ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" SetFocusOnError="True"
                            ...
                            <br />
                                <div>
                                    <ul class="frmctrl">
                                        <li><a class="pure-button button-green white-font" href="javascript:fn_CalcJS2()" title="Guardar">
                                            <i class="fa fa-calculator"></i>Calcular</a></li>
